...
function getColdStartPlan(timezone = 'UTC') {
  return { focus: null, next: [], blockers: [], carryovers: [], totalOpen: 0, confidence: 0, empty: true, coldStart: true, stage: 'simple', message: "Welcome to Krytz. Start by capturing anything on your mind — tasks, notes, ideas. We'll handle the rest.", suggestions: ["Try: 'Finish the project proposal by Friday'", "Try: 'Call the client about the contract'", "Try: 'Buy groceries — milk, eggs, bread'"], generatedAt: new Date().toISOString() };
}
