...
|---|---|---|---|---|
| **0** | Project Setup | 11 | 8 | 73% |
| **1A** | Server Backend + Normalization | 45 | 37 | 82% |
| **1B** | Mobile App | 33 | 0 | 0% |
| **2** | Retention | 8 | 0 | 0% |
| **3** | Connectors | 9 | 0 | 0% |
| **4** | Data Model + Priority + State (5D Pt 1) | 32 | 0 | 0% |
| **5** | Decision + Causality + Execution (5D Pt 2) | 17 | 0 | 0% |
| **6** | Observability (Inspector) | 22 | 0 | 0% |
| **7** | Intelligence + Learning + Bootstrap | 15 | 0 | 0% |
| **Infra** | DevOps | 10 | 3 | 30% |
| **Test** | Testing | 10 | 0 | 0% |
| **TOTAL** | | **212** | **48** | **23%** |
